...
const styles = StyleSheet.create({
  ...
  form: { marginTop: 30, gap: 9 },
  label: { marginTop: 8, fontSize: 14, fontWeight: '700' },
  input: { height: 52, borderWidth: 1, borderColor: '#ddd', borderRadius: 13, paddingHorizontal: 15, fontSize: 16 },
  button: { marginTop: 24, height: 54, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: '#111' },
  buttonDisabled: { opacity: 0.35 },
  buttonText: { color: '#fff', fontSize: 16, fontWeight: '700' },
  note: { marginTop: 16, textAlign: 'center', color: '#888', fontSize: 12, lineHeight: 18 }
});
