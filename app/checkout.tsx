...
const styles = StyleSheet.create({ container: { padding: 24, paddingTop: 56, paddingBottom: 48, backgroundColor: '#fff', flexGrow: 1 }, center: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 12, backgroundColor: '#fff' }, muted: { color: '#777', marginTop: 8 }, back: { fontSize: 15, fontWeight: '700', marginBottom: 28 }, eyebrow: { fontSize: 12, fontWeight: '800', letterSpacing: 1.5, color: '#777' }, title: { marginTop: 9, fontSize: 31, fontWeight: '800' }, body: { marginTop: 12, color: '#666', fontSize: 16, lineHeight: 23 }, section: { marginTop: 25, marginBottom: 9, fontSize: 18, fontWeight: '800' }, input: { height: 52, borderWidth: 1, borderColor: '#ddd', borderRadius: 13, paddingHorizontal: 15, fontSize: 15, marginBottom: 10 }, slotRow: { flexDirection: 'row', gap: 10, flexWrap: 'wrap' }, slot: { paddingVertical: 13, paddingHorizontal: 18, borderRadius: 13, borderWidth: 1, borderColor: '#ddd' }, slotSelected: { backgroundColor: '#111', borderColor: '#111' }, slotText: { fontWeight: '700' }, slotSelectedText: { color: '#fff', fontWeight: '700' }, error: { marginTop: 14, color: '#b00020', lineHeight: 20 }, summary: { marginTop: 24, padding: 18, borderWidth: 1, borderColor: '#e5e5e5', borderRadius: 15, flexDirection: 'row', justifyContent: 'space-between' }, summaryTitle: { fontWeight: '700' }, total: { fontSize: 21, fontWeight: '800' }, button: { marginTop: 18, minHeight: 54, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: '#111' }, buttonText: { color: '#fff', fontSize: 16, fontWeight: '700' } });
